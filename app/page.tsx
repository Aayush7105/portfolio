  ...
  return (
    ...
    bg-size-[20px_20px] flex justify-center items-center"
      ...
      dark:absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f1A_1px,transparent_1px),linear-gradient(to_bottom,#8080801A_1px,transparent_1px)] bg-size-[14px_24px] flex justify-center items-center  dark:border-neutral-700/50"
          >
            <div className="h-screen  w-[85%] border border-dashed border-neutral-600/40 dark:border-neutral-500/50 py-16  ">
              <div className="border-b border-t border-dashed border-neutral-600/40 dark:border-neutral-500/50 flex justify-between">
                <div className="w-[50%] flex">
                  <div className="w-[35%] border-r border-dashed border-neutral-500/50">
                    <Image
                      src={"/images.jpeg"}
                      alt="sjx"
                      quality={80}
