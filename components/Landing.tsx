...
const Landing = () => {
  return (
    <div className=" h-full w-full max-w-5xl flex justify-center items-center  bg-white dark:bg-neutral-950  ">
      <div
        className="h-full
bg-[linear-gradient(to_right,#00000001_1px,transparent_1px),
    linear-gradient(to_bottom,#00000003_1px,transparent_1px)]
ring ring-neutral-400/30
      ...
      >
        <div className="h-full sm:w-[90%] md:w-[85%] ring ring-dashed ring-neutral-500/40 bg-white  dark:bg-neutral-950 dark:ring-neutral-500/50 sm:py-16  flex flex-col ">
          <Hero />
          <Aboutme />
          <Contactme />
        </div>
